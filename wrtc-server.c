 ...
 * 3/17/22 g-maulino: update for a simple A/V client use-case
 */
#include <gst/gst.h>
...
static const gchar *peer_id = "1973";
static const gchar *server_url = "wss://webrtc.nirbheek.in:8443";
//static const gchar *server_url = "wss://localhost:8443"; // We use a 3rd party wss to avoid certificates handling for this demo
...
on_incoming_stream (GstElement * webrtc, GstPad * pad, GstElement * pipe)
{
  ...
  decodebin = gst_element_factory_make ("fakesink", NULL);
...
start_pipeline (void)
{
  ...
  pipe1 =
      ...
      STUN_SERVER
      "filesrc location=sintel_trailer-480p.webm ! decodebin name=decode1 ! videoconvert ! queue ! vp8enc deadline=1 ! rtpvp8pay ! "
      "queue ! " RTP_CAPS_VP8 "96 ! sendrecv. "
      "filesrc location=sintel_trailer-480p.webm ! decodebin name=decode2 ! audioconvert ! audioresample ! queue ! opusenc ! rtpopuspay ! "
...
#ifdef G_OS_UNIX
  g_unix_signal_add (SIGINT, exit_sighandler, loop);
  g_unix_signal_add (SIGTERM, exit_sighandler, loop);
#endif
